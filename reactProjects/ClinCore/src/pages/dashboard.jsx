            ...
            <div className="action-div">
              ...
              <div className="profile-div">
                <div className="profile-img">
                  <img src="/all-images/body-images/profile-avatar.jpg" alt="sultoon abdulraheem" onError={(e) => { e.currentTarget.src = '/all-images/body-images/doctor-1.jpg'; }} />
                </div>
            ...
            <div class="main-content">
                <div class="stats-grid">
                    <div class="stat-card">
                        ...
                        <div class="card-body">
                            <h2 class="stat-value">1,287</h2>
                            <span class="stat-badge badge-up">
                                <i class="bi bi-graph-up-arrow"></i>
                                <span>+2.14%</span>
                            </span>
                        </div>
                        <p class="stat-desc">56 more than yesterday</p>
                    </div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="card-body">
                            <h2 class="stat-value">965</h2>
                            <span class="stat-badge badge-up">
                                <i class="bi bi-graph-up-arrow"></i>
                                <span>+3.78%</span>
                            </span>
                        </div>
                        <p class="stat-desc">45 more than yesterday</p>
                    </div>
                    ...
                    <div class="stat-card">
                        ...
                        <p class="stat-desc">18 less than yesterday</p>
                    </div>
                        ...
                        <div class="activity-list">
                            <div class="activity-item">
                                ...
                                <div class="activity-content">
                                    <span class="activity-text">Felix M�ller was discharged from Room 205 after successful treatment</span>
                            ...
                            <div class="activity-item">
                                ...
                                <div class="activity-content">
                                    <span class="activity-text">L&eacute;a Rousseau admitted to Room 312 for surgery scheduled later today</span>
                ...
                <div class="page-footer">
                    <p class="footer-copy">Copyright &copy; 2024 Peterdraw</p>
